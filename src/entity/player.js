...
class Player {
    ...
    constructor(playerId, name, level, maxHealth, health, img, physicalAttack, physicalDefense, magicAttack, magicDefense, gold, experience){
    ...
    get getPlayerId(){return this.playerId}
    set setPlayerId(playerId){return this.playerId = playerId;}
